...
![Version: 1.4.2](https://img.shields.io/badge/Version-1.4.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.9.0](https://img.shields.io/badge/AppVersion-v0.9.0-informational?style=flat-square)
...
| configReloader.image.tag | string | `"1.30.11"` | tag to point at for k8s-sidecar tag 1.30.10 and 1.30.11 are currently bugged: https://github.com/kiwigrid/k8s-sidecar/issues/431#issuecomment-3401233149 |
